...
# Segments: ● P · dir · git branch · model · cost · context bar · tokens · rate limits
...
# Keep only the last path component (matches POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last)
...
# Session cost segment (hidden until first API call returns non-zero cost)
